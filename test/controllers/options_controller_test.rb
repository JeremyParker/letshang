...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post options_url, params: { option: { meeting_time: @option.meeting_time, reusable: @option.reusable, title: @option.title } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { meeting_time: @option.meeting_time, reusable: @option.reusable, title: @option.title } }
